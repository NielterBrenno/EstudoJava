...
public class ForumMailService {
	...
	public	void	sendNewReplyMail(Answer	answer) {
		...
		MimeMessagePreparator	messagePreparator	=	(mimeMessage) -> {
			...
			//messageHelper.setTo(answeredTopic.getOwnerName());
			
			String destinatario = "xavecef318@tmail7.com";
			...
			String MessageContext = this.newReplyMailFactory
					.generateNewReplyMailContent(answer);
			
			messageHelper.setText(MessageContext, true);
		};
